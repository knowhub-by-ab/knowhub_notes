...
```mermaid  
graph LR  
A[Declarative Learning] --> B[Facts & Concepts]  
C[Procedural Learning] --> D[Task Performance]  
E[Conceptual Learning] --> F[Abstract Ideas]  
G[Experiential Learning] --> H[Hands-On Experience]  
I[Explicit Learning] --> J[Conscious Effort]  
K[Implicit Learning] --> L[Unconscious Acquisition]  
```
