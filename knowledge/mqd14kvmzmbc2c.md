...
```mermaid
graph TD
    A[Attention: Focus on input] --> B{Encoding: Process & Store}
    B --> C[Storage: Retain in Memory Systems]
    C --> D{Retrieval: Access when needed}
    D --> E[Application: Use & Practice]
    E --> B
    E --> C
    E --> D
```
...
graph TD
    ...
    B -- Focused Attention --> C[Working Memory]
